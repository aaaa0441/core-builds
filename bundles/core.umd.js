...
function destroyViewTree(rootView) {
    ...
    var /** @type {?} */ viewOrContainer = rootView.child;
...
function renderEmbeddedTemplate(viewNode, template, context, renderer, directives, pipes) {
    ...
    try {
        ...
        var /** @type {?} */ isCreationOnly = (rf & 1 /* Create */) === 1;
...
function getOrCreateInjectable(di, token, flags) {
    ...
    if (bloomHash === null) {
        ...
        while (injector) {
            ...
            var /** @type {?} */ nodeFlags = /** @type {?} */ ((node.tNode)).flags;
            var /** @type {?} */ count = nodeFlags & 4095;
            if (count !== 0) {
                var /** @type {?} */ start = nodeFlags >> 13;
                var /** @type {?} */ end = start + count;
...
function bloomFindPossibleInjector(startInjector, bloomBit, flags) {
    ...
    // match.
    var /** @type {?} */ injector = flags & 4 /* SkipSelf */ ? /** @type {?} */ ((startInjector.parent)) : startInjector;
    while (injector) {
